...
class ProductManager {
    ...
    async addProduct(product) {
        ...
        try {
            if(file) {
                ...
                //If exist product with the same name
                ...
                if(prod) {
                    ...
                    try {
                        ...
                        return {status: "error", message: `Cannot create product ${prod}`}
                    }
    ...
    async getProducts() {
        try {
            ...
            if(!products) return {status: "error", message: "Cannot create product" + error};

            this.products = JSON.parse(products);
            return {status: "success", products: this.products, message: "Products"}
    ...
    async getProductById(id) {
        try {
            ...
            return {status: "error", message: "Cannot find product" + error}
        }
    }
    async updateProduct(id, data) {
        try {
            ...
            if(index>=0) {
                ...
                return {status: "error", message: "Product not found, can't update"}
            }
    ...
    async deleteProduct(id) {
        try {
            ...
            if(index >=0) {
                ...
                return {status: "error", message: "Cannot eliminate product"}
            }

        } catch (error) {
            return {status: "error", message: "Cannot eliminate product" + error}
        }
    }
}
...
// product.addProduct({ title: 'Macbook', description: 'High quality', price: 4500, thumbnail: '', code: '000A1', stock: 10})
//   .then(result => {
...
//     console.log(result.message);
// });
// product.getProductById(1).then(result => {
//     console.log(result.product);
//     console.log(result.message);
// });
// product.updateProduct(2, { title: 'Macbook', description: 'High quality', price: 4500, thumbnail: '', code: '000A1', stock: 10})
//   .then(result => {
//     console.log(result.message);
//     console.log(result.product);
// });
product.deleteProduct(1).then(result => {
    console.log(result.message);
});
